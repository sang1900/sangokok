...
async def channel_post(client: Client, message: Message):
    ...
    if id not in ADMINS or id in OWNER_ID:
    ...
    text=f"<b>✅ LƯU TRỮ THÀNH CÔNG \n\n🔗 Your URL : {link}</b>\n(Mở link trên để lấy URL dẫn đến file đã lưu trữ)\n(Tạo BOT lưu trữ tự quản lý hoặc xoá link rút gọn liên hệ <a href='https://fb.com/sang1900'>Nguyễn Sáng</a>)"
    if id in OWNER_ID:
        text=f"<b>✅ LƯU TRỮ THÀNH CÔNG \n\n🔗 Your URL : {link}\n🔗 Your URL : https://t.me/{client.username}?start={base64_string}</b>\n(Mở link trên để lấy URL dẫn đến file đã lưu trữ)\n(Tạo BOT lưu trữ tự quản lý hoặc xoá link rút gọn liên hệ <a href='https://fb.com/sang1900'>Nguyễn Sáng</a>)"
    await reply_text.edit(f"{text}", reply_markup=reply_markup, disable_web_page_preview = True)
